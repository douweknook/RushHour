...
# Board 1
board.addCar('00', 2, 'h', 2, 3) #Car 0 is the red car
board.addCar('01', 2, 'h', 0, 3)
board.addCar('02', 3, 'v', 0, 2)
board.addCar('03', 3, 'v', 0, 5)
board.addCar('04', 2, 'v', 4, 0)
board.addCar('05', 2, 'h', 4, 1)
board.addCar('06', 3, 'v', 3, 3)
board.addCar('07', 2, 'h', 3, 4)
board.addCar('08', 2, 'h', 5, 4)
